...
const Demo = () => {
  ...
  return ( 
    <section className='mt-16 w-full max-w-xl'>
      ...
      <button className='black_btn w-1/2' onClick={() => setIsHistoryVisible(!isHistoryVisible)}>History</button> {/* button to toggle visibility of history */}
      
      {isHistoryVisible && (
        <div className='history'>
          {/* code to display history goes here */}
        </div>
      )}
                ...
                {isFetching ? (
                  <img src={loader} alt='loader' className='w-20 h-20 object-contain' />
                    ...
                    <p className='font-inter font-bold text-black text-center'>
                      ...
                      <span clasNam='font-satoshi font-normal text-gray-700'>
                        {error?.data?.error}
                      </span>
                      </p>
                      )
